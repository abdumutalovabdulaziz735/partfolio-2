...
import picture from "../assets/img/my-own-picture.png";
        ...
        <div className="container">
          <div className="header_box">
            <div className="header_left">
              ...
              <h1 className="header_left_text">
                Abdumutalov <br /> Abdulaziz
              </h1>
              <p className="header_left_small">Front-end Developer</p>
              <div className="header_left_icons">
                <a href="#about" className="header_left_icons_icon1">
                  About me
                </a>
                <a href="#jobs" className="header_left_icons_icon2">
                  Jobs
                </a>
              </div>
            </div>
            <div className="header_right">
              <img className="header_right_img" src={picture} alt="" />
